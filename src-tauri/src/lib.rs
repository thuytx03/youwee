...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            // Video Editor commands (cloned from Processing, independent module)
            commands::editor_get_video_metadata,
            commands::editor_detect_shot_changes,
            commands::editor_get_image_metadata,
            commands::editor_get_attachment_info,
            commands::editor_generate_command,
            commands::editor_generate_quick_action_command,
            commands::editor_execute_ffmpeg_command,
            commands::editor_cancel_ffmpeg,
            commands::editor_get_history,
            commands::editor_save_job,
            commands::editor_update_job,
            commands::editor_delete_job,
            commands::editor_clear_history,
            commands::editor_get_presets,
            commands::editor_save_preset,
            commands::editor_delete_preset,
            commands::editor_generate_video_preview,
            commands::editor_generate_video_thumbnail,
            ...
            commands::editor_transcribe_video,
            commands::editor_local_tts_status,
            commands::editor_local_tts_install,
            commands::editor_local_tts_uninstall,
            commands::editor_local_tts_voices,
            commands::editor_local_tts_warm,
            commands::editor_local_tts_sample,
            commands::editor_local_tts_engine_config,
            commands::editor_local_tts_set_engine_config,
            commands::editor_local_tts_add_voice,
            commands::editor_local_tts_delete_voice,
            commands::editor_local_tts_record_generation,
            commands::editor_local_tts_generations,
            commands::editor_local_tts_delete_generation,
            commands::editor_local_tts_version,
            commands::editor_local_tts_update,
            commands::editor_local_tts_storage,
            commands::editor_local_tts_clean_models,
            ...
            commands::check_facefusion,
            commands::install_facefusion,
            commands::uninstall_facefusion,
            commands::facefusion_storage,
            commands::clean_facefusion_models,
            commands::get_facefusion_config_cmd,
            commands::set_facefusion_config_cmd,
            commands::editor_face_swap,
