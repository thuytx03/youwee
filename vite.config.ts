    ...
    alias: [
      ...
      // must be listed before the bare package aliases so they match first.
      {
        ...
        replacement: path.resolve(
          import.meta.dirname,
          './src/vendor/elah/editor/src/styles/tokens.css',
        ),
      },
      {
        find: '@elah/editor/styles.css',
        replacement: path.resolve(import.meta.dirname, './src/vendor/elah/editor/dist/styles.css'),
      },
      {
        find: '@elah/core',
        replacement: path.resolve(import.meta.dirname, './src/vendor/elah/core/src/index.ts'),
      },
      {
        find: '@elah/editor',
        replacement: path.resolve(import.meta.dirname, './src/vendor/elah/editor/src/index.ts'),
      },
      {
        find: '@elah/timeline',
        replacement: path.resolve(import.meta.dirname, './src/vendor/elah/timeline/src/index.ts'),
      },
